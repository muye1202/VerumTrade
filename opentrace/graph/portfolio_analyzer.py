...
from opentrace.agents.portfolio.triage_agent import PortfolioTriageAgent
from opentrace.agents.utils.llm.llm_metrics import snapshot_llm_api_calls
...
class PortfolioAnalyzer:
    ...
    def _analyze_positions(
        ...
        try:
            ...
            from opentrace.agents.journal.ingestion.hooks import (
