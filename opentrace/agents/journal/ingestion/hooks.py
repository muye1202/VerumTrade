...
from opentrace.agents.journal.core.models import TradeThesis, ThesisStatus
from opentrace.agents.journal.core.store import JournalStore
from opentrace.agents.journal.ingestion.thesis_extractor import ThesisExtractor
...
def capture_trade_thesis(
    ...
    Args:
        ...
        final_state: From OpenTraceGraph.propagate()
