...
- A standalone daemon via `python -m opentrace.journal.scheduler`
...
from opentrace.agents.journal.core.models import TradeThesis, TradeOutcome
from opentrace.agents.journal.execution.execution_advisor import JournalExecutionAdvisor
from opentrace.agents.journal.execution.execution_policy import JournalExecutionPolicy
...
class JournalScheduler:
    ...
    def __init__(
        ...
        if resolved_llm_client is None and llm_config:
            from opentrace.agents.journal.evaluation.llm_evaluator import build_llm_client_from_config
...
def main():
    ...
    Usage:
        python -m opentrace.journal.scheduler [--db-path PATH] [--interval MINUTES]
    """
    import argparse
    import os
