...
(``opentrace.agents.discovery.theme_engine.taxonomy.ThemeTaxonomyLoader``) as an automatic fallback
...
def _taxonomy_peers(ticker: str, config: Optional[Dict[str, Any]]) -> List[str]:
    ...
    try:
        from opentrace.agents.discovery.theme_engine.taxonomy import ThemeTaxonomyLoader
