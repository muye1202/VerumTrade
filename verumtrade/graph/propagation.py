# verumtrade/graph/propagation.py

from typing import Dict, Any, Optional
from verumtrade.utils.market_session import (
...
from verumtrade.agents.analysts.workbench import normalize_ledger
from verumtrade.agents.utils.agent_runtime.evidence_graph import build_evidence_graph
from verumtrade.graph.evidence_ledger_schema import validate_admissible_evidence
from verumtrade.graph.reasoning_trace import empty_agent_reasoning_trace
...
class Propagator:
    ...
    def create_initial_state(
        ...
        if pullback_vulnerability is None:
