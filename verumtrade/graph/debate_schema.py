...
from verumtrade.graph.structured_schemas import ResearchDebateTurn, ThesisLedger, TraderPlan
...
def debate_validation_context_from_state(state: dict[str, Any] | None) -> dict[str, Any]:
    ...
    if not isinstance(ledger, list) or not ledger:
        from verumtrade.graph.evidence_ledger_schema import (
...
def evaluate_risk_response_contract(
    ...
    """
    from verumtrade.graph.plan_patch_schema import extract_plan_patches_from_text
