...
from verumtrade.agents.discovery.intelligence_integration import (
...
class StockDiscoveryGraph:
    ...
    def __init__(
        ...
        Args:
            config: Configuration dict (same format as VerumtradeGraph)
    ...
    def _create_llm(self, model: str) -> ChatOpenAI:
        ...
        if provider == "glm":
            from verumtrade.graph.verumtrade_graph import GLMFlashSerialChatOpenAI, GLMCompatibleChatOpenAI
            ...
            from verumtrade.graph.verumtrade_graph import OpenRouterCompatibleChatOpenAI
    ...
    def discover_and_analyze(
        ...
        This integrates with BatchAnalyzer to run full VerumtradeGraph
        ...
        # Step 2: Deep Analysis using full VerumtradeGraph
