...
class AlpacaExecutor:
    """
    Executes Verumtrade trading signals on Alpaca paper trading.
    ...
    def _regular_market_is_open(self) -> Optional[bool]:
        ...
        try:
            from verumtrade.utils.market_session import describe_us_market_session
    ...
    def execute_signal(
        ...
        """
        Execute an Verumtrade trading signal.

        Args:
            ticker: Stock ticker symbol
            signal: Trading signal (BUY, SELL, or HOLD)
            analysis_state: Full Verumtrade analysis state (optional, for logging)
