...
INDICATOR_DESCRIPTIONS = {
    ...
    "adx": "ADX: Average Directional Index measures trend strength (0-100) regardless of direction. Usage: Values above ~25 indicate a meaningful trend; combine with price structure or moving averages for direction. Tips: ADX can lag at turning points; use with momentum and volume confirmation.",
...
INDICATOR_SPECS = {
    ...
    "adx": {"endpoint": "adx", "value_key": "adx", "params": {"time_period": 14}},
