...
- A standalone daemon via `python -m verumtrade.journal.scheduler`
...
from verumtrade.agents.journal.core.models import TradeThesis, TradeOutcome
from verumtrade.agents.journal.execution.execution_advisor import JournalExecutionAdvisor
from verumtrade.agents.journal.execution.execution_policy import JournalExecutionPolicy
...
class JournalScheduler:
    ...
    def __init__(
        ...
        if resolved_llm_client is None and llm_config:
            from verumtrade.agents.journal.evaluation.llm_evaluator import build_llm_client_from_config
        ...
        from verumtrade.agents.journal.evaluation.smart_evaluator import SmartPlanEvaluator
...
def main():
    ...
    Usage:
        python -m verumtrade.journal.scheduler [--db-path PATH] [--interval MINUTES]
    """
    import argparse
    import os
