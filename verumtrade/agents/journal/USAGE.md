...
now to keep Verumtrade's safety posture clear: the main product surface is a
...
| Area | Module |
|:--|:--|
| SQLite store and models | `verumtrade.agents.journal.core` |
| Report/thesis ingestion helpers | `verumtrade.agents.journal.ingestion` |
| Outcome monitoring internals | `verumtrade.agents.journal.monitoring` |
| Reflection and lesson memory | `verumtrade.agents.journal.learning` |
| Portfolio sync helpers | `verumtrade.agents.journal.portfolio` |
