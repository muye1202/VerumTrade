...
def _load_env_if_present() -> None:
    ...
    Many scripts/tests import tradingagents directly without going through cli/main.py,
    ...
    repo_root = here.parents[2]  # .../tradingagents/dataflows/config.py -> repo root
